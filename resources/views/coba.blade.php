...
<body>
  ...
  <section id="beranda" class="relative grid min-h-[88vh] place-items-center">
    ...
    <div class="absolute inset-0 bg-cover bg-center" style="background-image:url('{{ asset('img/hero.png') }}');"
      {{-- ganti ke path gambar Anda, contoh yang Anda kirim --}} aria-hidden="true"></div> <!-- Overlay -->
    <div class="absolute inset-0 bg-gradient-to-b from-black/50 via-black/30 to-black/60"></div>
    <div class="relative z-10 mx-auto max-w-4xl px-6 text-center text-white">
      <h1 class="font-playfair text-4xl font-semibold tracking-tight sm:text-5xl md:text-6xl"> Lorem Ipsum Dolor Sit
        Amet </h1>
      <p class="mt-4 text-base text-white/90 sm:text-lg">Lorem ipsum dolor sit amet consectetur adipiscing elit quisque
      </p>
      <div class="mt-10">
        <a href="#destinasi"
    ...
    <a href="#destinasi" class="group absolute bottom-6 left-1/2 -translate-x-1/2 text-white/80">
      ...
      <span class="relative block h-10 w-6 overflow-hidden rounded-full border border-white/60">
        <span class="animate-wheel absolute left-1/2 top-2 h-1.5 w-1.5 -translate-x-1/2 rounded-full bg-white/90">
        </span>
      </span>
  ...
  <section id="destinasi" class="bg-gray-50 py-16">
    <div class="mx-auto max-w-7xl px-6">
      <header class="mb-8">
        ...
        <p class="mt-2 max-w-2xl text-gray-600">Lorem ipsum dolor sit amet consectetur adipiscing elit quisque faucibus
          ex sapien vitae pellentesque sem placerat in.</p>
      </header>
        ...
        @foreach ([1, 2, 3] as $i)
          <article class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
            ...
            <div class="p-5">
              ...
              <p class="mt-2 text-sm text-gray-600">Lorem ipsum dolor sit amet consectetur adipiscing elit quisque
                faucibus ex sapien vitae pellentesque sem placerat in.</p>
              <div class="mt-4">
                <a href="#"
                  class="inline-flex items-center justify-center rounded-md bg-amber-500 px-4 py-2 text-white transition hover:bg-amber-600">Selengkapnya</a>
              </div>
            </div>
          </article>
        @endforeach
  ...
  <section id="virtual"
    ...
    <div class="relative mx-auto max-w-7xl px-6 text-emerald-50">
      ...
      <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        @foreach ([1, 2, 3, 4] as $i)
          <figure class="relative">
            ...
            <figcaption class="absolute bottom-2 left-2 rounded bg-black/40 px-2 py-1 text-xs font-medium">Spot
              {{ $i }}</figcaption>
          </figure>
        @endforeach
      </div>
      ...
      <div class="mt-10 text-center">
        <a href="#"
          class="inline-flex items-center rounded-lg border border-emerald-200/70 px-6 py-3 transition hover:bg-emerald-800/50">Explore
          Now</a>
      </div>
    </div>
  </section>
